...
namespace Paloma
{
...

    {
        ...
        public PixelFormat TGAPixelFormat { get; set; }
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            TGAPixelFormat = PixelFormat.Format32bppArgb;
            ...
            this.LoadThumbnail(binReader, TGAPixelFormat);
        ...
        private PixelFormat GetPixelFormat()
        {
            ...
            TGAPixelFormat = pfTargaPixelFormat;
            return TGAPixelFormat;
        }
